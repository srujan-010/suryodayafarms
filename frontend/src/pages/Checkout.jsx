  ...
  return (
    <div className="min-h-screen bg-cream-bg pt-28 pb-16 px-4 sm:px-6 md:px-12">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 items-start">
              ...
              <div className="flex flex-col gap-3">
                {addresses.map((addr) => (
                  <label
                    ...
                    className={`flex gap-4 items-start p-4 rounded-2xl border cursor-pointer transition-all duration-300 ${
                      selectedAddressId === addr.id
                        ? 'bg-cream-bg border-primary-green/60 shadow-sm'
                  ...
                  >
                    ...
                    />
                    <div className="flex flex-col text-xs font-sans text-dark-text/75 leading-relaxed font-light">
        ...
        {/* Right Side: Order Summaries & Checkout totals */}
        <div className="w-full lg:w-[400px] bg-light-beige/25 border border-light-beige rounded-[36px] p-6 md:p-8 shrink-0 text-left flex flex-col gap-6">
          ...
          {/* Coupon apply box */}
          <form onSubmit={handleApplyCoupon} className="border-t border-b border-light-beige/60 py-4 my-2 flex flex-col gap-3">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-grow bg-cream-bg border border-light-beige rounded-xl py-2.5 px-4 font-sans text-xs focus:outline-none focus:border-sunrise-gold uppercase"
              />
              <button
                type="submit"
                className="bg-primary-green hover:bg-dark-olive text-white px-5 rounded-xl font-sans text-[10px] font-bold uppercase tracking-wider transition-colors cursor-pointer"
              >
                Apply
              </button>
            </div>
                ...
                <div className="flex flex-wrap gap-1.5">
                  {activeCoupons.map((c) => (
                    <button
                      ...
                      className="bg-primary-green/5 border border-primary-green/20 hover:border-primary-green/50 rounded-lg px-2.5 py-1 text-[10px] font-semibold text-primary-green transition flex items-center gap-1 cursor-pointer select-none active:scale-95 border-solid"
                    >
